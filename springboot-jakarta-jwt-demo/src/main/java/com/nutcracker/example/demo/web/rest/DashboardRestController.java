...
public class DashboardRestController {
    ...
    public RespWrapper<Map<String, Object>> dashboard() {
        ...
        RespWrapper<Map<String, Object>> resp = RespWrapper.success(model);
        log.info("/api/dashboard, resp={}", JSON.toJSONString(resp));
        return resp;
    }
}
